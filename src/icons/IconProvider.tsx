    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{display: "none"}}>
            ...
            <symbol id={ICON_TYPES.chevronRight} viewBox="0 0 24 24" fill="none">
                <path d="M8.25 18.75L15.75 12L8.25 5.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"/>
            </symbol>
            <symbol id={ICON_TYPES.plus} viewBox="0 0 16 16" fill="none">
                <path d="M7.75 0.75V14.75M0.75 7.75H14.75" stroke="currentColor" stroke-width="1.5"
                      stroke-linecap="round" stroke-linejoin="round"/>
            </symbol>
            <symbol id={ICON_TYPES.eyeClose} viewBox="0 0 24 24" fill="none">
                <path d="M19.4996 16L17.0244 12.6038" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M12 17.5V14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M4.5 16L6.96895 12.6124" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M3 8C6.6 16 17.4 16 21 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"/>
            </symbol>
            <symbol id={ICON_TYPES.eyeOpen} viewBox="0 0 19 14" fill="none">
                ...
                <path
                    ...
                    stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>
                <circle cx="9.33887" cy="6.79932" r="3.25" stroke="currentColor" stroke-width="1.5"/>
            </symbol>
            <symbol id={ICON_TYPES.info_filled} viewBox="0 0 20 20" fill="none">
                ...
                <path d="M10 14V9M10 6.2V6" stroke="none" stroke-width="1.5" stroke-linecap="round"/>
            </symbol>
            <symbol id={ICON_TYPES.info} viewBox="0 0 20 20" fill="none">
                <g clip-path="url(#clip0_6394_61337)">
                    <path d="M10 5.5V11M10 14.1V14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round"/>
                    <path
            ...
            <symbol id={ICON_TYPES.checkbox_outline} viewBox="0 0 18 18" fill="none">
                <rect x="-0.5" y="0.5" width="17" height="17" rx="3.5" transform="matrix(-1 0 0 1 17 -5.96047e-08)"
                      stroke="currentColor"/>
                <path d="M13.5 6.75L9 11.25L4.5 6.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"/>
            </symbol>
            <symbol id={ICON_TYPES.arrowUp} viewBox="0 0 18 18" fill="none">
                <path d="M13.5 11.25L9 6.75L4.5 11.25" stroke="none" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"/>
            </symbol>
            ...
            <symbol id={ICON_TYPES.warning_outline} viewBox="0 0 24 24" fill="none">
                ...
                <path d="M12 8V13.25M12 16.4V16.25" stroke="currentColor" stroke-width="2.25" stroke-linecap="round"
                      stroke-linejoin="round"/>
            </symbol>
            ...
            <symbol id={ICON_TYPES.dotsHorizontalBold} viewBox="0 0 24 24" fill="none">
                <circle cx="5.75" cy="12" r="1.25" stroke="currentColor" stroke-width="1.40625"/>
                <circle cx="12" cy="12" r="1.25" stroke="currentColor" stroke-width="1.40625"/>
                <circle cx="18.25" cy="12" r="1.25" stroke="currentColor" stroke-width="1.40625"/>
            </symbol>
            ...
            <symbol id={ICON_TYPES.checkBold} viewBox="0 0 19 13" fill="none">
                <path d="M17.5996 1.1001L7.09961 11.6001L1.09961 5.6001" stroke="currentColor" stroke-width="2.2"
                      stroke-linecap="round" stroke-linejoin="round"/>
            </symbol>
            ...
            <symbol id={ICON_TYPES.checkDouble} viewBox="0 0 26 24" fill="none">
                <path d="M19.5 6.75L9 17.25L3 11.25" stroke="currentColor" stroke-width="2.05" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M24 6.75L13.5 17.25M7.5 11.25L9 12.75" stroke="currentColor" stroke-width="2.05"
                      stroke-linecap="round" stroke-linejoin="round"/>
            </symbol>
            <symbol id={ICON_TYPES.close} viewBox="0 0 24 24" fill="none">
                <path d="M6.34277 17.6567L17.6565 6.34303" stroke="currentColor" stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M6.34277 6.34326L17.6565 17.657" stroke="currentColor" stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"/>
            </symbol>
            ...
            <symbol id={ICON_TYPES.clockZero} viewBox="0 0 24 24" fill="none">
                ...
                <path d="M12 7.5L12 11.8913L15 13.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
            </symbol>
            <symbol id={ICON_TYPES.clockSeven} viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.6"/>
                <path d="M12 9L12 14.2675L15 16.1972" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
            </symbol>
            <symbol id={ICON_TYPES.clockRefresh} viewBox="0 0 25 24" fill="none">
                ...
                <path d="M12.2998 7.5L12.2998 11.8913L15.2998 13.5" stroke="currentColor" stroke-width="1.6"
                      stroke-linecap="round" stroke-linejoin="round"/>
            </symbol>
            <symbol id={ICON_TYPES.youtube} viewBox="0 0 24 24" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.002 15L15.198 12L10.002 9V15Z"
                      stroke="currentColor"
            ...
            <symbol id={ICON_TYPES.facebook} viewBox="0 0 24 24" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M7.5 3H16.504C18.987 3 21 5.013 21 7.496V16.505C21 18.987 18.987 21 16.504 21H7.496C5.013 21 3 18.987 3 16.504V7.5C3 5.015 5.015 3 7.5 3V3Z"
                      stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M11.0996 12.8999H16.4996" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
            ...
            <symbol id={ICON_TYPES.user} viewBox="0 0 18 18" fill="none">
                <g clip-path="url(#clip0_6394_61331)">
                    <circle cx="8.66677" cy="4.33328" r="3.61111" stroke="currentColor" stroke-width="1.5"/>
                    <path
            ...
            <symbol id={ICON_TYPES.wallet} viewBox="0 0 24 24" fill="none">
                ...
                <path d="M12.002 21.0015H18.502C19.8827 21.0015 21.002 19.8822 21.002 18.5015V16.5015"
                      stroke="currentColor"
                      stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                <circle cx="5.99902" cy="18" r="4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                        stroke-linejoin="round"/>
                <path d="M7.3443 17.2078L5.6643 18.8868L4.6543 17.8798" stroke="currentColor" stroke-width="1.6"
                      stroke-linecap="round" stroke-linejoin="round"/>
                <path
            ...
            <symbol id={ICON_TYPES.documentCertificate} viewBox="0 0 24 24" fill="none">
                <path d="M9 5.5H15" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M18 9H6" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M6 14.5H9" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path
                    ...
                    stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M17 17.2202V21.9992L15 20.9992L13 21.9992V17.2202" stroke="currentColor" stroke-width="1.6"
                      stroke-linecap="round" stroke-linejoin="round"/>
                <path
            ...
            <symbol id={ICON_TYPES.calendarClock} viewBox="0 0 24 24" fill="none">
                <circle cx="17.5" cy="16.5" r="4.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                        stroke-linejoin="round"/>
                <path d="M3.40039 8.80005H17.6004" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M7.5 2V5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M16.5 2V5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path
                    d="M10 20H6C4.34315 20 3 18.6569 3 17V6.5C3 4.84315 4.34315 3.5 6 3.5H18C19.6569 3.5 21 4.84315 21 6.5V9"
                    stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M7 12.3999H8" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M10.5996 12.3999H11.5996" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M7 15.6001H8" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M17.3926 14.9836V16.7372L18.7748 17.5804" stroke="currentColor" stroke-width="1.6"
                      stroke-linecap="round" stroke-linejoin="round"/>
            </symbol>
            ...
            <symbol id={ICON_TYPES.calendarMini} viewBox="0 0 22 22" fill="none">
                <path d="M14.3333 2V4.66667" stroke="currentColor" stroke-width="1.33333" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M7.00033 2V4.66667" stroke="currentColor" stroke-width="1.33333" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path d="M2.66504 7.99913H18.665" stroke="currentColor" stroke-width="1.33333" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <rect x="2.66699" y="3.33325" width="16" height="15.3333" rx="2.66667" stroke="currentColor"
                      stroke-width="1.33333"/>
                <path d="M7.33333 11.3333H6" stroke="currentColor" stroke-width="1.33333" stroke-linecap="round"/>
                <path d="M11.3333 11.3333H10" stroke="currentColor" stroke-width="1.33333" stroke-linecap="round"/>
                <path d="M15.3333 11.3333H14" stroke="currentColor" stroke-width="1.33333" stroke-linecap="round"/>
                <path d="M7.33333 14.6667H6" stroke="currentColor" stroke-width="1.33333" stroke-linecap="round"/>
                <path d="M11.3333 14.6667H10" stroke="currentColor" stroke-width="1.33333" stroke-linecap="round"/>
                <path d="M15.3333 14.6667H14" stroke="currentColor" stroke-width="1.33333" stroke-linecap="round"/>
            </symbol>
            ...
            <symbol id={ICON_TYPES.warningTriangle} viewBox="0 0 24 24" fill="none">
                <g clip-path="url(#clip0_6394_61439)">
                    <path
                        ...
                        stroke="currentColor" stroke-width="1.6"/>
                    <path d="M12 9.6001V13.7251M12 16.2001V16.0822" stroke="currentColor" stroke-width="1.4"
                          stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <defs>
            ...
            <symbol id={ICON_TYPES.copy} viewBox="0 0 24 24" fill="none">
                <rect x="4" y="3" width="11.6664" height="13.3334" rx="2" stroke="currentColor" stroke-width="1.4"/>
                <path
